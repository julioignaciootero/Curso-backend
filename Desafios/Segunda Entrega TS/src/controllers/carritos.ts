...
export const checkBodyCarrito = async ( req : Request ,  res : Response , next : NextFunction) => {
...
export const updateStock = async ( id : mongoose.Types.ObjectId , cantidad : number , sumar : boolean ) => {
...
export const getAllCarritos = async ( req : Request ,  res : Response ) => {
